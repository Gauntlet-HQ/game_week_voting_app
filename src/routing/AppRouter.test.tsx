...
describe("AppRouter", () => {
  ...
  it("does not leave a public /gallery route from the name gate", async () => {
  ...
  it("routes an honor-system voter into the four-banner voting hall", async () => {
  ...
  it("keeps a stored voter out of the public gallery and in the voting hall", async () => {
  ...
  it("opens the Heraldry gallery only from the staff keep", async () => {
    const user = userEvent.setup();
    writeHonorSystemSessionToBrowserStorage({
      token: "staff-token",
      voterId: "22222222-2222-2222-2222-222222222222",
